                ...
                <div className="max-w-4xl mx-auto flex flex-col items-center items-start bg-white rounded-lg overflow-hidden shadow-md">
                    ...
                    <div className=" p-8 ">
                        ...
                        <div className='mt-6 text-center'>
                            <a href={content.imdb_link} className="box-border relative z-30 inline-flex items-center justify-center w-auto px-8 py-3 overflow-hidden font-bold text-white transition-all duration-300 bg-indigo-600 rounded-md cursor-pointer group ring-offset-2 ring-1 ring-indigo-300 ring-offset-indigo-200 hover:ring-offset-indigo-500 ease focus:outline-none">
