            ...
            <div className="container mx-auto py-8 px-4 sm:px-0">
                <div className="max-w-4xl mx-auto flex flex-col items-center items-start bg-white rounded-lg overflow-hidden shadow-md">
                    <div className="md:w-1/2 md:mb-0 md:order-first mt-6">
                        <img className="h-auto w-full w-full object-cover " src={content.big_image} alt={content.title} />
                    </div>
                    <div className=" p-8 ">
                        ...
                        <div className="mt-4 flex gap-2 flex-wrap">
                            ...
                            {content.genre.map((genre, index) => (
                                <span key={index} className="text-indigo-600 border-solid border-2 border-indigo-600 px-2">{genre}</span>
                            ))}
                        </div>
                        <div className="mt-2">
                        ...
                        <div className="mt-2">
                            ...
                            <a href={content.imdb_link} target="_blank" rel="noopener noreferrer" className="text-indigo-600">{content.rating}</a>
                        </div>
                        <div className='mt-6 text-center'>
                            <a href={content.imdb_link} target="_blank" className="box-border relative z-30 inline-flex items-center justify-center w-auto px-8 py-3 overflow-hidden font-bold text-white transition-all duration-300 bg-indigo-600 rounded-md cursor-pointer group ring-offset-2 ring-1 ring-indigo-300 ring-offset-indigo-200 hover:ring-offset-indigo-500 ease focus:outline-none">
