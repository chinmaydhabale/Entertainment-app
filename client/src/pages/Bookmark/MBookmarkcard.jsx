...
const MBookmarkcard = ({ movie, removeBookmarkCard }) => {
  ...
  return (
    <div className="movie-card relative overflow-hidden group">
      ...
      <button onClick={() => removebookmark(movie._id)} className="bookmark-icon absolute top-0 right-0 p-2 opacity-0 group-hover:opacity-100 z-10">
